...
他们甚至为他们的底层框架[Cordis](https://github.com/cordiverse/cordis)写了一篇80+页的论文, 通过形式的语言证明自己的可插拔框架的灵活与可靠. 客观上他们实现的东西确实值得肯定, 但在AI的大背景下, 你们的论文并没有解决什么实际的问题, 有很多人喜欢提"自进化", 可是你的技术栈似乎也没有什么高灵活性.
